...
function initializeGmap() {
	if ($('#map_canvas').length) {
		...
		if (document.getElementById("map_canvas") != null) {
			...
			var dropshadow = new google.maps.MarkerImage("https://riot.design/assets/img/shadow.png", null, null, null, new google.maps.Size(82, 32));
			var image = new google.maps.MarkerImage("https://riot.design/assets/img/marker.png", null, null, null, new google.maps.Size(47, 56));
...
//urls
var AAPLsiteurl = "https://riot.design";
var AAPLhome = "https://riot.design";
